...
class Confirmation extends React.Component {
    ...
    constructor(props) {
        ...
        let formData = JSON.parse(localStorage.getItem("coa_forms_compost_class_data"));
        let confirmationNumber = localStorage.getItem("coa_forms_compost_class_confirmation_number") || "N/A";
        let submitUrl = localStorage.getItem("coa_forms_compost_class_submiturl") || "";
        let userEmail = "";
        try {
    ...
    render() {
        ...
        return (
          <div className="schemaform-intro">
            ...
            <p>Thank you! We received your composting class request and will respond soon. A copy of your request will be delivered to your email, if shared.</p>
          </div>
        );
  }
}
